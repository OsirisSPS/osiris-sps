;NSIS TranslateEditor Main Setup
...
;General
	...
	OutFile "..\..\repository\windows\TranslateEditor.exe"
	
	; Adds an XP manifest to the installer
	XPStyle on
	
	;Default installation folder
	InstallDir "$PROGRAMFILES\Kodeware\TranslateEditor"
	
	;Get installation folder from registry if available
	InstallDirRegKey HKLM "Software\Kodeware\TranslateEditor" ""
...
;Language Selection Dialog Settings
	...
	!define MUI_LANGDLL_REGISTRY_KEY "Software\Kodeware\TranslateEditor" 
...
;Pages
	...
	!define MUI_STARTMENUPAGE_REGISTRY_KEY "Software\Kodeware\TranslateEditor" 
	!define MUI_STARTMENUPAGE_REGISTRY_VALUENAME "Start Menu Folder"
	!define MUI_STARTMENUPAGE_DEFAULTFOLDER "Kodeware\TranslateEditor"
...
;License Language String
	...
	LicenseLangString MUILicense ${LANG_ENGLISH} "..\..\data\license\en\License.txt"
...
;Installer Sections
	...
	Section "!Engine" SecEngine
		...
		; Basic (required) TranslateEditor files...
		
		File "..\..\..\utils\TranslateEditor\bin\release\Settings.xml"
		File "..\..\..\utils\TranslateEditor\bin\release\TranslateEditor.exe"
		
		SetOutPath "$INSTDIR\Flags"
		File "..\..\..\utils\TranslateEditor\bin\release\Flags\*.*"
				
		;Store installation folder
		WriteRegStr HKLM "Software\Kodeware\TranslateEditor" "" $INSTDIR
		
		; Write the uninstall keys for Windows
		WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\TranslateEditor" "DisplayName" "TranslateEditor - Kodeware"
		WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\TranslateEditor" "UninstallString" '"$INSTDIR\uninstall.exe"'
		WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\TranslateEditor" "SupportUpgrade" "yes"
		WriteRegDWORD HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\TranslateEditor" "NoModify" 1
		WriteRegDWORD HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\TranslateEditor" "NoRepair" 1
		...
		CreateShortCut "$SMPROGRAMS\$STARTMENU_FOLDER\TranslateEditor.lnk" "$INSTDIR\TranslateEditor.exe"
...
Section "Uninstall"
	...
	Delete "$INSTDIR\TranslateEditor.exe"
	...
	;Qui c'è questo loop e non un semplice  "RMDir "$INSTDIR"" perchè se uno specifica C:\Programmi\Kodeware\TranslateEditor, il setup
	;deve rimuovere anche la directory Kodeware se non ci sono altre sottodirectory diverse da TranslateEditor.
	...
	Delete "$SMPROGRAMS\$MUI_TEMP\TranslateEditor.lnk"
	...
	DeleteRegKey HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\TranslateEditor"
	DeleteRegKey HKLM "Software\Kodeware\TranslateEditor"
...
Function LaunchLink  
	ExecShell "open" "$INSTDIR\TranslateEditor.exe"
FunctionEnd
