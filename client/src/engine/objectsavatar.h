...
#ifndef _OBJECTS_AVATAR_H
#define _OBJECTS_AVATAR_H
...
class EngineExport ObjectsAvatar : public ObjectsIEntry
{
...
public:
	ObjectsAvatar();
	virtual ~ObjectsAvatar();

// Attributes
public:
	static bool validateFormat(shared_ptr<Portal> portal, const Buffer &buffer);
...
inline shared_ptr<ObjectsAvatar> objects_avatar_cast(shared_ptr<ObjectsIObject> object) { return boost::dynamic_pointer_cast<ObjectsAvatar>(object); }

//////////////////////////////////////////////////////////////////////

class ObjectsAvatarDescriptor : public ObjectsDescriptor<ObjectsAvatarDescriptor>
{
	OS_DECLARE_DESCRIPTOR(ObjectsAvatarDescriptor, portalObjectTypeAvatar);

	typedef ObjectsDescriptor<ObjectsAvatarDescriptor> DescriptorBase;

// Construction
public:
	ObjectsAvatarDescriptor();
	virtual ~ObjectsAvatarDescriptor();
