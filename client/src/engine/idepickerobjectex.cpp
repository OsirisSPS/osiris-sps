...
const String IdePickerObjectEx::EVENT_OPEN = _S("onOpen");
const String IdePickerObjectEx::EVENT_SELECT = _S("onSelect");

//////////////////////////////////////////////////////////////////////

IdePickerObjectEx::IdePickerObjectEx()
{
	m_multipleSelection = false;

	getEvents()->get(EVENT_OPEN)->connect(boost::bind(&IdePickerObjectEx::onOpen, this, _1));
	getEvents()->get(EVENT_SELECT)->connect(boost::bind(&IdePickerObjectEx::onSelect, this, _1));
}
...
String IdePickerObjectEx::getValue() const
{
	return String::EMPTY; 
}

void IdePickerObjectEx::setValue(const String &id)
{
	//m_ids = id;
}

void IdePickerObjectEx::onLoad()
{
	ControlBase::onLoad();
...
void IdePickerObjectEx::onPreRender()
{
...
void IdePickerObjectEx::exportObject(StringMap& opens, shared_ptr<EntitiesEntity> entity, shared_ptr<XMLNode> nodeParent)
{
...
void IdePickerObjectEx::onLoadViewState(const DataTree &state)
{
...
void IdePickerObjectEx::onSaveViewState(DataTree &state)
{
...
String IdePickerObjectEx::getTemplatePath()
{
