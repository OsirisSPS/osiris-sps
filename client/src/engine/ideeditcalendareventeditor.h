...
#ifndef _IDE_EDIT_CALENDAREVENTEDITOR_H
#define _IDE_EDIT_CALENDAREVENTEDITOR_H
...
class EngineExport CalendarEventEditor : public IObjectEditor
{
...
private:
	...
	shared_ptr<IdePickerDateTime> m_startDate;
	shared_ptr<IdePickerDateTime> m_endDate;
	shared_ptr<HtmlComboBox> m_repeatMode;
	shared_ptr<IdePickerDateTime> m_expirationDate;
};
...
#endif // _IDE_EDIT_CALENDAREVENTEDITOR_H
