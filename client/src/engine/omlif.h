...
#ifndef _IDE_BBCODES_IF_H
#define _IDE_BBCODES_IF_H
...
class EngineExport OMLIf : public IOMLCode
{
// Construction
public:
	OMLIf(const String& tag);
	virtual ~OMLIf();
...
// Internal:
private:
	bool matchCondition(shared_ptr<OMLItem> i, shared_ptr<OMLContext> context, const String &condition) const;
