...
#ifndef _OBJECTS_POLLVOTE_H
#define _OBJECTS_POLLVOTE_H
...
class EngineExport ObjectsPollVote : public ObjectsIEntry
{
...
public:
	ObjectsPollVote();
	virtual ~ObjectsPollVote();

// Attributes
public:
	bool isNull() const;
	bool isReferencedTo(const EntityID &reference);
...
inline shared_ptr<ObjectsPollVote> objects_poll_vote_cast(shared_ptr<ObjectsIObject> object) { return boost::dynamic_pointer_cast<ObjectsPollVote>(object); }

//////////////////////////////////////////////////////////////////////

class ObjectsPollVoteDescriptor : public ObjectsDescriptor<ObjectsPollVoteDescriptor>
{
	OS_DECLARE_DESCRIPTOR(ObjectsPollVoteDescriptor, portalObjectTypePollVote);

	typedef ObjectsDescriptor<ObjectsPollVoteDescriptor> DescriptorBase;

// Construction
public:
	ObjectsPollVoteDescriptor();
	virtual ~ObjectsPollVoteDescriptor();
