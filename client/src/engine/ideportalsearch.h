...
#ifndef _IDE_PORTAL_SEARCH_H
#define _IDE_PORTAL_SEARCH_H
...
class EngineExport Search : public IPortalPage
{
...
// Construction
public:
	Search(shared_ptr<HttpSession> session);
	virtual ~Search();
