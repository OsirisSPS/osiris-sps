...
#ifndef _IDE_VIEW_CALENDAREVENTVIEWER_H
#define _IDE_VIEW_CALENDAREVENTVIEWER_H
...
class CalendarEventViewer : public CommentableObjectViewer
{
...
#endif // _IDE_VIEW_CALENDAREVENTVIEWER_H
