...
#ifndef _IDE_PORTAL_ASSISTANT_H
#define _IDE_PORTAL_ASSISTANT_H
...
class EngineExport Assistant : public HtmlVirtualPage<IPortalPage>
{
...
// Construction
public:
	Assistant(shared_ptr<HttpSession> session);
	virtual ~Assistant();
