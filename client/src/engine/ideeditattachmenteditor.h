...
#ifndef _IDE_EDIT_ATTACHMENTEDITOR_H
#define _IDE_EDIT_ATTACHMENTEDITOR_H
...
class AttachmentEditor : public IObjectEditor
{
...
private:
	shared_ptr<HtmlCheckBox> m_enableBrowser;
	shared_ptr<HtmlFileBrowser> m_browser;
};
...
#endif // _IDE_EDIT_ATTACHMENTEDITOR_H
