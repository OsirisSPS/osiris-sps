...
#ifndef _IDE_BBCODES_IMG_H
#define _IDE_BBCODES_IMG_H
...
class EngineExport OMLImg : public OMLHtmlWrapper
{
// Construction
public:
	OMLImg(const String& tag);
	virtual ~OMLImg();
