...
#ifndef _IDE_VIEW_POSTVIEWER_H
#define _IDE_VIEW_POSTVIEWER_H
...
class PostViewer : public IObjectViewer
{
...
// Operations
public:
	void addPost(shared_ptr<EntitiesEntity> entity);
...
private:
	EntitiesEntity::EntitiesList m_posts;
};
