...
#ifndef _IDE_EDIT_SECTIONEDITOR_H
#define _IDE_EDIT_SECTIONEDITOR_H
...
class EngineExport SectionEditor : public IObjectEditor
{
...
private:
	...
	shared_ptr<IdeOMLEditor> m_description;
	shared_ptr<HtmlComboBox> m_componentsList;
	shared_ptr<ExtensionsComponentEditor> m_editor;
	shared_ptr<IExtensionsComponent> m_component;
	shared_ptr<ObjectsSection> m_current;
};
...
#endif // _IDE_EDIT_SECTIONEDITOR_H
