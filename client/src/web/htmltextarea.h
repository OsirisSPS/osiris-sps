...
#ifndef _OS_HTML_HTMLTEXTAREA_H
#define _OS_HTML_HTMLTEXTAREA_H
...
class WebExport HtmlTextArea : public IHtmlControl
{
...
public:
	...
	inline void setValue(const String &text);
...
inline const String & HtmlTextArea::getValue() const { return m_text; }
inline void HtmlTextArea::setValue(const String &text) { m_text = text; }
