...
#ifndef _OS_CORE_PLATFORMLINUX_H
#define _OS_CORE_PLATFORMLINUX_H
...
public:
	...
	double tickCount();
	static void trace(const std::string &message, const char *file, size_t line, const char *function);
...
private:
	...
	std::multimap<String, String> m_extensions;
	std::multimap<String, String> m_mimeTypes;
};
...
#endif // _OS_CORE_PLATFORMLINUX_H
