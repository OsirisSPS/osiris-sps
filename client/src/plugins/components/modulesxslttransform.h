...
#ifndef _COMPONENTS_MODULES_XSLTTRANSFORM_H
#define _COMPONENTS_MODULES_XSLTTRANSFORM_H
...
class XsltTransform : public IExtensionsModule
{
...
#endif // _COMPONENTS_MODULES_XSLTTRANSFORM_H
