...
#ifndef _COMPONENTS_MODULES_QUICKSEARCH_H
#define _COMPONENTS_MODULES_QUICKSEARCH_H
...
class QuickSearch : public IExtensionsModule
{
...
#endif // _COMPONENTS_MODULES_QUICKSEARCH_H
