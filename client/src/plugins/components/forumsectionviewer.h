...
#ifndef _COMPONENTS_FORUM_SECTIONVIEWER_H
#define _COMPONENTS_FORUM_SECTIONVIEWER_H
...
class SectionViewer : public IXSLRenderer<ExtensionsComponentViewer>
{
...
#endif // _COMPONENTS_FORUM_SECTIONVIEWER_H
