...
#ifndef _COMPONENTS_MODULES_LANGUAGESWITCHER_H
#define _COMPONENTS_MODULES_LANGUAGESWITCHER_H
...
class LanguageSwitcher : public IExtensionsModule
{
...
#endif // _COMPONENTS_MODULES_LANGUAGESWITCHER_H
