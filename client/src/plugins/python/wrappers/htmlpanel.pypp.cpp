...
#include "htmlpanel.pypp.hpp"

namespace bp = boost::python;

struct HtmlPanel_wrapper : ::osiris::HtmlPanel, ::osiris::PythonWrapper< ::osiris::HtmlPanel > {
...
void register_HtmlPanel_class(){
    ...
    ::boost::python::class_< HtmlPanel_wrapper, ::boost::python::bases< ::osiris::IHtmlControl >, ::boost::noncopyable >( "HtmlPanel", ::boost::python::init< >() )    
        .def( 
            "decodeEvent"
            , (bool ( HtmlPanel_wrapper::* )( ::osiris::String const &,::osiris::String &,::osiris::HtmlEvent & ) const)(&HtmlPanel_wrapper::decodeEvent)
            , ( ::boost::python::arg("command"), ::boost::python::arg("eventName"), ::boost::python::arg("e") ) )    
        .def( 
            "encodeEvent"
            , (::osiris::String ( HtmlPanel_wrapper::* )( ::osiris::String const &,::osiris::HtmlEvent const * ) const)(&HtmlPanel_wrapper::encodeEvent)
        ...
        .def( 
            ...
            , (::boost::shared_ptr< osiris::HttpSession > ( HtmlPanel_wrapper::* )(  ) const)(&HtmlPanel_wrapper::default_getSession) )    
        .def( 
            "onEvent"
            , (void ( HtmlPanel_wrapper::* )( ::osiris::String const &,::osiris::IEvent * ) )(&HtmlPanel_wrapper::default_onEvent)
            , ( ::boost::python::arg("name"), ::boost::python::arg("e")=(nullptr) ) )    
        .def( 
            "onInit"
            , (void ( HtmlPanel_wrapper::* )(  ) )(&HtmlPanel_wrapper::default_onInit) )    
        .def( 
            "onLoad"
            , (void ( HtmlPanel_wrapper::* )(  ) )(&HtmlPanel_wrapper::default_onLoad) )    
        .def( 
            "onLoadViewState"
            , (void ( HtmlPanel_wrapper::* )( ::osiris::DataTree const & ) )(&HtmlPanel_wrapper::default_onLoadViewState)
            , ( ::boost::python::arg("state") ) )    
        .def( 
            "onPreRender"
            , (void ( HtmlPanel_wrapper::* )(  ) )(&HtmlPanel_wrapper::default_onPreRender) )    
        .def( 
            "onRender"
            , (void ( HtmlPanel_wrapper::* )( ::osiris::HtmlWriter & ) )(&HtmlPanel_wrapper::default_onRender)
            , ( ::boost::python::arg("writer") ) )    
        .def( 
            "onSaveViewState"
            , (void ( HtmlPanel_wrapper::* )( ::osiris::DataTree & ) )(&HtmlPanel_wrapper::default_onSaveViewState)
            , ( ::boost::python::arg("state") ) )    
        .def( 
            "renderAttributes"
            , (void ( ::osiris::IHtmlControl::* )( ::osiris::HtmlWriter & ) )(&::osiris::IHtmlControl::renderAttributes)
            , (void ( HtmlPanel_wrapper::* )( ::osiris::HtmlWriter & ) )(&HtmlPanel_wrapper::default_renderAttributes)
            , ( ::boost::python::arg("writer") ) )    
        .def( 
            "renderChilds"
            , (void ( ::osiris::IHtmlControl::* )( ::osiris::HtmlWriter & ) )(&::osiris::IHtmlControl::renderChilds)
            , (void ( HtmlPanel_wrapper::* )( ::osiris::HtmlWriter & ) )(&HtmlPanel_wrapper::default_renderChilds)
            , ( ::boost::python::arg("writer") ) )    
        .def( 
            "saveViewState"
            , (void ( HtmlPanel_wrapper::* )( ::osiris::DataTree & ) )(&HtmlPanel_wrapper::saveViewState)
