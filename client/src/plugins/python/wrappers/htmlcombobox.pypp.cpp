...
#include "htmlcombobox.pypp.hpp"

namespace bp = boost::python;

struct HtmlComboBox_wrapper : ::osiris::HtmlComboBox, ::osiris::PythonWrapper< ::osiris::HtmlComboBox > {
...
void register_HtmlComboBox_class(){
    ...
    ::boost::python::class_< HtmlComboBox_wrapper, ::boost::python::bases< ::osiris::IHtmlSelect >, ::boost::noncopyable >( "HtmlComboBox", ::boost::python::init< >() )    
        .def( 
            "decodeEvent"
            , (bool ( HtmlComboBox_wrapper::* )( ::osiris::String const &,::osiris::String &,::osiris::HtmlEvent & ) const)(&HtmlComboBox_wrapper::decodeEvent)
        ...
        .def( 
            ...
            , (::boost::shared_ptr< osiris::HttpSession > ( HtmlComboBox_wrapper::* )(  ) const)(&HtmlComboBox_wrapper::default_getSession) )    
        .def( 
            "onEvent"
        ...
        .def( 
            "onLoad"
            , (void ( HtmlComboBox_wrapper::* )(  ) )(&HtmlComboBox_wrapper::default_onLoad) )    
        .def( 
            "onLoadViewState"
            , (void ( HtmlComboBox_wrapper::* )( ::osiris::DataTree const & ) )(&HtmlComboBox_wrapper::default_onLoadViewState)
            , ( ::boost::python::arg("state") ) )    
        .def( 
            "onPreRender"
            , (void ( HtmlComboBox_wrapper::* )(  ) )(&HtmlComboBox_wrapper::default_onPreRender) )    
        .def( 
            "onRender"
            , (void ( HtmlComboBox_wrapper::* )( ::osiris::HtmlWriter & ) )(&HtmlComboBox_wrapper::default_onRender)
            , ( ::boost::python::arg("writer") ) )    
        .def( 
            "onSaveViewState"
            , (void ( HtmlComboBox_wrapper::* )( ::osiris::DataTree & ) )(&HtmlComboBox_wrapper::default_onSaveViewState)
            , ( ::boost::python::arg("state") ) )    
        .def( 
            "renderAttributes"
            , (void ( ::osiris::IHtmlSelect::* )( ::osiris::HtmlWriter & ) )(&::osiris::IHtmlSelect::renderAttributes)
            , (void ( HtmlComboBox_wrapper::* )( ::osiris::HtmlWriter & ) )(&HtmlComboBox_wrapper::default_renderAttributes)
            , ( ::boost::python::arg("writer") ) )    
        .def( 
            "renderChilds"
            , (void ( ::osiris::IHtmlControl::* )( ::osiris::HtmlWriter & ) )(&::osiris::IHtmlControl::renderChilds)
            , (void ( HtmlComboBox_wrapper::* )( ::osiris::HtmlWriter & ) )(&HtmlComboBox_wrapper::default_renderChilds)
            , ( ::boost::python::arg("writer") ) )    
        .def( 
            "saveViewState"
            , (void ( HtmlComboBox_wrapper::* )( ::osiris::DataTree & ) )(&HtmlComboBox_wrapper::saveViewState)
