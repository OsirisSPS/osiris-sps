...
ensureOption("services.link.redirect", "http://www.osiris-sps.org/isis/link.php?{id}");
...
ensureOption("services.clock.enabled", false);
ensureOption("services.clock.local", true);
ensureOption("services.clock.server", "time.ien.it");
ensureOption("services.update.enabled", false);
ensureOption("services.update.redirect", "http://www.osiris-sps.org/isis/update.php");
ensureOption("services.update.version", 0.1);
ensureOption("services.update.notes", "");
ensureOption("services.bootstrap.enabled", false);
ensureOption("services.bootstrap.redirect", "http://www.osiris-sps.org/isis/bootstrap.php");
...
ensureOption("tuning.request.timeout", (double) iif(customizableTimeLimit(),60*60,getMaxExecutionTime()));
...
ensureOption("portals.default.isis.cache.always", "");
...
ensureOption("portals.default.anonymity.html_mode", 0);
...
ensureOption("portals.default.web.redirect_url", "http://www.osiris-sps.org/isis/redirect.php?#url#");
ensureOption("portals.default.system.isis", "http://www.osiris-sps.org/isis");
